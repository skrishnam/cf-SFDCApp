...
public class AccountServiceController {
    ...
    public @ResponseBody List<Account> getContactsByAccounts() {
		...
		try {
			...
			if (result == null) throw new NullPointerException("Service currently unavailable.");
		} catch (Exception e) {
			throw new NullPointerException("Service currently unavailable.");
		}
     	return result;
//    	return getResult("/accounts","getContactsByAccounts");
    }
    ...
    public @ResponseBody List<Account> getOpportunitiesByAccounts() {
		...
		try {
     	...
     	return result;
//     	return getResult("/opp_by_accts","getOpportunitiesByAccounts");
    }
    ...
    private List<Account> getResult(String key, String type) {
    	...
    	List<Account> result = null;
		try {
			Method method = accountService.getClass().getMethod(type,String.class);
			result = (List<Account>) method.invoke(accountService, key);
			if (result == null) throw new NullPointerException("Service currently unavailable.");
		} catch (Exception e) {
			throw new NullPointerException("Service currently unavailable.");
		}
